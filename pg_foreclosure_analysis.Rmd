...
pg_foreclosures_with_tracts <- pg_foreclosures_with_tracts[order(pg_foreclosures_with_tracts$propertyid, pg_foreclosures_with_tracts$street_address, pg_foreclosures_with_tracts$city.y, pg_foreclosures_with_tracts$year_month), ]

# Keep only the last row from each set of duplicates
pg_foreclosures_with_tracts <- subset(pg_foreclosures_with_tracts, !duplicated(pg_foreclosures_with_tracts[, c("propertyid", "street_address", "city.y", "year_month")], fromLast = TRUE))

# Reset row names if necessary
rownames(pg_foreclosures_with_tracts) <- NULL
```
