...
Next, we can use the trained models to predict on our testing data. We will show the results together with confidence and prediction bands and prediction accuracy using (1) the correlation between the predicted and real values and (2) the mean square error between the two.
