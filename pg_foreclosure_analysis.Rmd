...
for (variable in variables_of_interest_subset_1) {
  ...
  predictions <- predict(model, newdata = pg_foreclosures_test, interval = "prediction", level = 0.95)
  ...
  matlines(x = pg_foreclosures_test$foreclosure_pc_2020, 
           y = predictions[, c("fit", "lwr", "upr")], 
           lty = c(1, 2, 2), col = c("black", "blue", "blue"), lwd = c(1, 1, 1))
