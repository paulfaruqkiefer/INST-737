...
The combination of variables from the *linear regression section* of this milestone that produced the most predictive model do not work in this case -- they include too much collinearity for the function to work. 
...
summary(model_5)
```
This model is the most predictive we've tried, and -- surprisingly -- the percentage of residents in a tract claiming non-Hispanic white ancestry is the most predictive variable in this model. 


We can also calculate the odds ratio for each variable. 
...
```
A correlation coefficient of 0.87 is not bad, but we are only dealing with five quantiles - we could use a better sense of how accurate this model is.
