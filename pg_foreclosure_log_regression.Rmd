...
```{r}
# Use the imputed dataset for model fitting
model <- polr(foreclosure_quantile ~ tract_homevalue_2020 + pct_built_2010_2019 + pct_built_pre_1960 + avg_bed + mortgage_change_2010_2020, data = train_data, Hess = TRUE)
